...
namespace SIDomper.Apresentacao.App
{
    public class ModuloApp
    {
        ...
        {
            string url = Constantes.URL + "modulo?novo={0}&idUsuario={1}";
        ...
        {
            string url = Constantes.URL + "modulo/?codigo={0}";
        ...
        {
            string url = Constantes.URL + "modulo?campo={0}&texto={1}&ativo={2}&contem={3}&idCliente={4}";
