...
namespace SIDomper.Apresentacao.App
{
    public class CategoriaApp
    {
        ...
        {
            string url = Constantes.URL + "categoria/?codigo={0}";
        ...
        {
            string url = Constantes.URL + "categoria?campo={0}&texto={1}&ativo={2}&contem={3}&idCliente={4}";
