...
namespace SIDomper.Apresentacao.App
{
    public class ProdutoApp
    {
        ...
        {
            string url = Constantes.URL + "produto/Novo?idUsuario={0}";
        ...
        {
            string url = Constantes.URL + "produto/Filtrar?campo={0}&texto={1}&ativo={2}";
